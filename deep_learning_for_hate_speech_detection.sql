...
--
-- Host: localhost
-- Generation Time: Feb 17, 2021 at 12:21 PM
...
--
-- Database: `deep_learning_for_hate_speech_detection`
--
CREATE DATABASE IF NOT EXISTS `deep_learning_for_hate_speech_detection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `deep_learning_for_hate_speech_detection`;
...
('qjc0x130twwpd3rlho5fjd8obhwdadhr', 'eyJ1c2VyaWQiOjEwfQ:1lCLkR:Uo0-7g29gZLnU7AsAhw9iYZTF3GYXHEP-qsW5v4mP0E', '2021-03-03 12:16:03.277853'),
...
(10, 'Kiran', 'kiran123@gmail.com', 'Kiran', '9535866270', 'India', 'Karnataka', 'Bangalore');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_hate_speech_review_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_hate_speech_review_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `names` varchar(300) NOT NULL,
  `age` varchar(300) NOT NULL,
  `dob` varchar(300) NOT NULL,
  `gender` varchar(300) NOT NULL,
  `ethnicity` varchar(300) NOT NULL,
  `religion` varchar(300) NOT NULL,
  `color` varchar(300) NOT NULL,
  `nationality` varchar(300) NOT NULL,
  `city` varchar(300) NOT NULL,
  `speecher` varchar(300) NOT NULL,
